 ...
 */
public class CadastroEspaco extends javax.swing.JFrame {

    /**
     * Creates new form CadastroEspaco
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Espacos");
    ...
    private void BotaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadastrarActionPerformed
        ...
        if(!CampoNome.getText().equals("") && !CampoLotacao.getText().equals("") && CampoLotacao.getText().matches("[0-9]+")){
            ...
            if(c.CadastrarEspaco(CampoNome.getText(), Integer.parseInt(CampoLotacao.getText()))){
                JOptionPane.showMessageDialog(null, "Espaço Cadastrada com Sucesso!");
                CampoNome.setText("");
                CampoLotacao.setText("");
            } else {
                JOptionPane.showMessageDialog(null, "Número máximo de Espaços para café atingidos");
            }
        } else  {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroEspaco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroEspaco().setVisible(true);
            }
        });
    }
