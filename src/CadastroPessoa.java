...
public class CadastroPessoa extends javax.swing.JFrame {
    ...
    private void BotaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadastrarActionPerformed
        // Cadastrar
        if (!CampoNome.getText().equals("") && !CampoSobrenome.getText().equals("")) {
            Cadastrar c = new Cadastrar();

            if (!c.CadastrarPessoa(CampoNome.getText(), CampoSobrenome.getText())) {
                JOptionPane.showMessageDialog(null, "Não há salas ou Espaços de Café disponíveis");
            } else {
